...
public class XMLDocument {
    ...
    private String templateDistrictName="DISTRICT";
    private String templateDistrictID="0";
    ...
    public void changeRegion(String region, String id){
        ...
        for(int i=0;i<environmentChilds.getLength();i++){
            if( "controlinfo".equals(environmentChilds.item(i).getNodeName()) ){
                String x=environmentChilds.item(i).getAttributes().getNamedItem("title").getTextContent();
