...
public class ActivityDetails {
    ...
    public ActivityDetails(String name, String id, String specGroupValue){
        this.name = name;
        this.id = id;
        this.specGroupValue = specGroupValue;
    }
    ...
    /**
     * @return the specGroupValue
     */
    public String getSpecGroupValue() {
        return specGroupValue;
    }

    /**
     * @param specGroupValue the specGroupValue to set
     */
    public void setSpecGroupValue(String specGroupValue) {
        this.specGroupValue = specGroupValue;
    }
